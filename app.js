...
const esp32FilesApi = require('./routes/esp32FilesApi');
...
app.use('/api/esp32', esp32Routes); // ESP32 센서 API
app.use('/api/esp32', esp32FilesApi); // ESP32 파일 관리 API
app.use('/api/esp32', esp32FeaturesApi); // ESP32 특징 데이터 API
